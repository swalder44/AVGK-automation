...
+ " WHERE ID = " + IDTSIsh + " ;";
        ...
        public void ZUIDAng (int IDTSIsh, string UID)
        {            
                commandStringTest = "UPDATE vehiclecontainer_r"
   + " SET `UIDAng` = '" + UID + "'"
   + " WHERE ID = " + IDTSIsh + " ;";
            }
            public void ZaprObrOTPRLoc(int IDTSIsh, string NamU, int Ch, string Stat, string CodNar, int StAng, string NGRZ, string ANGKOGDA, string NameAkt)
        {
            if (StAng == 0)
            {
                //           if(Stat== "Нарушений не выявлено")
                //           {
                //               commandStringTest = "UPDATE vehiclecontainer_r"
                //+ " SET `Change` = 1,"
                //+ " ChangeType = " + Ch + ","
                //+ " DateChang = now(),"
                //+ " NameUs = 'AUTO',"
                //+ " IDVStup = " + Convert.ToDecimal(CodNar) + ","
                //+ " IsOverweightGroup = 0,"
                //               + " IsOverweightGross = 0," 
                //               + " IsOverweightPartial = 0,"
                //               + " IsOversized  = 0,"
                //               + " IsOverspeed  = 0,"
                //               + " Prim = '" + Stat.ToString() + "'"
                //+ " WHERE ID = " + IDTSIsh + " ;";
...
+ " WHERE `test`.`alcam`.`id` = " + IDTS + ";";
    ...
    + " WHERE allandnapr.ID = " + IDTS + "; ";
        ...
        public void ZaprBitmapPHOTOAuto(Int64 IDTS, string PLID)//для 2 и 3 формы
        {
            if (IDTS == 0)
            {
                commandStringTest = "SELECT * "
  ...
  + " FROM raptssprrazr";
        ...
        public void ZaprLevKontr(int IDTS, string D1, string D2, int CountZ)
        {
            if (IDTS == 0)
            {
                string dd1 = "";
        ...
        public void ZaprPravKontr(int IDTS, string D1, string D2, int CountZ)
        {
            if (IDTS == 0)
            {
                string dd1 = "";
        ...
        public void ZaprPravKontrOF(int IDTS, string D1, string D2, int CountZ)
        {
            if (IDTS == 0)
            {
                string dd1 = "";
