...
namespace AVGK
{
    class AutoKlass
    {
        ...
        public string CodSTAll; public string CodSTGabarL; public string CodSTGabarW; public string CodSTGabarH; public string CodSTSpeed; int PrNar;
  ...
  //      }
        ...
        //    A1[258] = EDIzm; A1[259] = SubKKl.ToString();
        ...
        public void PDKOs() {
          try {
                ...
                ////////}
                #endregion //////////////////////////
                if (Convert.ToInt32(data1.a[2]) > 1)
                {
                    ...
                    for (PrNar = 1; PrNar < 25; PrNar++)
                    {
                        ...
                        if (PrevNar[PrNar] > 0)
                        {
                            ...
                            else if (iNar >= 18 && iNar < 21)
                            {
                                ...
                                //}
                                if (iNar == 18) { CodSTGabarL = PrevNar[34].ToString(); NNarushen = "IsExceededLength"; UPDDannNarAndKl(NNarushen); } else { CodSTGabarL = "0"; }
                                if (iNar == 19) { CodSTGabarW = PrevNar[34].ToString(); NNarushen = "IsExceededWidth"; UPDDannNarAndKl(NNarushen); } else { CodSTGabarW = "0"; }
                                if (iNar == 20) { CodSTGabarH = PrevNar[34].ToString(); NNarushen = "IsExceededHeight"; UPDDannNarAndKl(NNarushen); } else { CodSTGabarH = "0"; }
        ...
        public void ZGabarPDK()
        {
            ...
            if (data1.a[247] != "-")
            {
                if (Convert.ToDouble(data1.a[58]) - Convert.ToDouble(data1.a[247]) > 0)
                {
                    ...
                    PrevDlPr = Convert.ToDouble(Math.Round(100 - (Convert.ToDouble(data1.a[247]) / Convert.ToDouble(data1.a[58]) * 100), 0));
                    PrevNar[19] = PrevDlPr;
                }
                if (Convert.ToDouble(data1.a[58]) - Convert.ToDouble(data1.a[247]) <= 0)
                {
            ...
            else
            {
                if (Convert.ToDouble(data1.a[58]) - Convert.ToDouble(data1.a[59]) > 0)
                {
                    ...
                    PrevNar[38] = 1;
                    PrevNar[39] = Math.Round(Convert.ToDouble(XDate[9]) * 100, 0);
                    PrevDlPr = Convert.ToDouble(Math.Round(100 - (Convert.ToDouble(data1.a[59]) / Convert.ToDouble(data1.a[58]) * 100), 0));
                    PrevNar[19] = PrevDlPr;
                }
                if (Convert.ToDouble(data1.a[58]) - Convert.ToDouble(data1.a[59]) <= 0)
                {
            ...
            //{
                ...
                PrevNar[38] = 1;
                PrevNar[39] = Math.Round(Convert.ToDouble(XDate[9]) * 100, 0);
                PrevDlPr = Convert.ToDouble(Math.Round(100 - (Convert.ToDouble(data1.a[62]) / Convert.ToDouble(data1.a[60]) * 100), 0));
                PrevNar[20] = PrevDlPr;
            }
                if (Convert.ToDouble(data1.a[60]) - Convert.ToDouble(data1.a[62]) <= 0)
                {
            ...
            if (XDate[12].ToString() != "False")
            {
                ...
                if (Convert.ToDouble(data1.a[58]) - Convert.ToDouble(XDate[20].ToString()) > 0)
                {
                    ...
                    //PrevDlPr = Convert.ToDouble(Math.Floor(Math.Round(Convert.ToDouble(data1.a[55]) / Convert.ToDouble(data1.a[56]) / 100 - 100, 2)));
                    PrevDlPr = Convert.ToDouble(Math.Round(100 - (Convert.ToDouble(XDate[20]) / Convert.ToDouble(data1.a[58]) * 100), 0));
                    PrevNar[19] = PrevDlPr;
                }
                if (Convert.ToDouble(data1.a[58]) - Convert.ToDouble(XDate[20].ToString()) <= 0)
                {
                ...
                if (Convert.ToDouble(data1.a[60]) - Convert.ToDouble(XDate[21].ToString()) > 0)
                {
                    ...
                    //PrevDlPr = Convert.ToDouble(Math.Floor(Math.Round(Convert.ToDouble(data1.a[55]) / Convert.ToDouble(data1.a[56]) / 100 - 100, 2)));
                    PrevDlPr = Convert.ToDouble(Math.Round(100 - (Convert.ToDouble(XDate[21]) / Convert.ToDouble(data1.a[60]) * 100), 0));
                    PrevNar[20] = PrevDlPr;
                }
                if (Convert.ToDouble(data1.a[60]) - Convert.ToDouble(XDate[21].ToString()) <= 0)
                {
                    ...
                    if (ic <= 9)
                    {
                        ...
                        if (D[ic] > 0)
                        {
                            ...
                            else if (Convert.ToInt32(TypO[ic]) > 1 && D[ic - 1] <= D[ic])// если сдвоенная/строенная предидущее расстояние меньше настоящего (напр: 1+2... а это 3)
                            {
                                ...
                                }//(SrednRTel / (TypO[ic] - 1) * 100)); //(D[ic - 1] * 100));}
